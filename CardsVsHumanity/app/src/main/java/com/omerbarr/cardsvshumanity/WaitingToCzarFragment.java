...
import static com.omerbarr.cardsvshumanity.BusinessLogic.PlayerManager.BROAD_CAST_ACK_START_GAME;
 ...
 * Use the {@link WaitingToCzarFragment#newInstance} factory method to
...
public class WaitingToCzarFragment extends Fragment {
    ...
    public static WaitingToCzarFragment newInstance() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().sendBroadcast(new Intent(BROAD_CAST_ACK_START_GAME));
